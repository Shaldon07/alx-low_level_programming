...
/**
 * sorted_list - function which inserts new node in sorted
 * @ht: pointer that points to sorted hash table
 ...
 * Return: pointer that points to hash table
 */
...
/**
 * shash_table_set - function which adds an element to the sorted hash table
 * @ht: pointer that points to sorted hash table
 * @key: key to add the element
 * @value: value to add the element
 * Return: 1 when successful else, 0 when otherwise
 */
...
/**
 * shash_table_get - function that retrieves value associated with key
 * @ht: pointer that points to hash table
...
/**
 * shash_table_print - function that prints the key:value from ht
 * @ht: pointer that points to hash table
 */
